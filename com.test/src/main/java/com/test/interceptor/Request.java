...
public class Request {
    ...
    public String getRequestPath() {
        ...
        return requestObj.getStringValue(StringUtils.fromString(Constants.RESOURCE_PATH)).getValue();
    }
    ...
    public String getRequestHttpMethod() {
        return requestObj.getStringValue(StringUtils.fromString(Constants.REQUEST_METHOD)).getValue();
    }
    ...
    public String getRequestHttpVersion() {
        return requestObj.getStringValue(StringUtils.fromString(Constants.REQUEST_HTTP_VERSION)).getValue();
    }
    ...
    public String getPathInfo() {
        return requestObj.getStringValue(StringUtils.fromString(Constants.PATH_INFO)).getValue();
    }
    ...
    public String getUserAgent() {
        return requestObj.getStringValue(StringUtils.fromString(Constants.USER_INFO)).getValue();
    }
